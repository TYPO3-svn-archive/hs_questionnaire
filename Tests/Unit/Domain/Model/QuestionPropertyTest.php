...
/**
 * Test case for class Tx_HsQuestionnaire_Domain_Model_QuestionProperty.
 *
 * @version $Id$
 ...
 *
 */
class Tx_HsQuestionnaire_Domain_Model_QuestionPropertyTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
